...
def downloadinfo(url, domain, Cookie, coll):
    ...
    if ps[0].text != u'该会员从未签到':
        user[u'AllSignInTime'] = ps[0].find(name = 'b').text
        print u'AllSignInTime->', user[u'AllSignInTime']
        user[u'ThisMonthSignInTime'] = ps[1].find(name = 'b').text
        print u'ThisMonthSignInTime->', user[u'ThisMonthSignInTime']
        user[u'LastSignInTime'] = ps[2].find(name = 'font').text
        print u'LastSignInTime->', user[u'LastSignInTime']
        user[u'AllReward'] = ps[3].text
        print u'AllReward->', user[u'AllReward']
        user[u'SignInLevel'] = ps[4].find(name = 'b').text
        print u'SignInLevel->', user[u'SignInLevel'] 
