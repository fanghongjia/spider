...
æ•°æ®åº?
'''
conn=MySQLdb.connect(host="172.26.253.87",user="root",passwd="YUgjBN",db="htys",charset="utf8")
cursor = conn.cursor()
'''
å…¨å±€å˜é‡è®¾ç½®
'''
...
for k in range(1,21):
	response = urllib2.urlopen('http://www.htys123.com/forum.php?mod=forumdisplay&fid=40&orderby=dateline&filter=author&orderby=dateline&page='+str(k))
