...
æ•°æ®åº?
'''
conn=MySQLdb.connect(host="172.26.253.87",user="root",passwd="YUgjBN",db="loulanpo",charset="utf8")
cursor = conn.cursor()
'''
å…¨å±€å˜é‡è®¾ç½®
'''
...
for k in range(1,2):
	response = urllib2.urlopen('http://www.loulanpo.com/forum.php?mod=forumdisplay&fid=48&orderby=dateline&filter=author&orderby=dateline&page='+str(k))
