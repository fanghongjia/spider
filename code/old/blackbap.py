...
spiderUrl = "http://bbs.blackbap.org/forum.php?mod=forumdisplay&fid=2&orderby=dateline&filter=author&orderby=dateline&page="
# 入库存储的板块名称
board = "社区小黑板 - Forum Board"
# 该板块内需要爬取的起始页号
page_start = 1
# 该板块内需要爬取的终止页号
page_end = 3
